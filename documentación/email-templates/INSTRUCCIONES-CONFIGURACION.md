...
## 0. Configuración SMTP (REQUERIDO)

**Sin configurar SMTP, los correos de verificación NO se enviarán.**

### Paso 1: Configurar SMTP en Supabase

1. Ve a **Authentication → SMTP Settings** en el Dashboard de Supabase
2. Activa **Enable Custom SMTP**
3. Configura con los datos de Resend:

| Campo | Valor |
|-------|-------|
| **Sender email** | `hola@ondeon.es` |
| **Sender name** | `Ondeón` |
| **Host** | `smtp.resend.com` |
| **Port** | `465` |
| **Username** | `resend` |
| **Password** | Tu `RESEND_API_KEY` (ej: `re_xxxxxxxxxx`) |
...
2. Asegúrate de que **Confirm email** está **habilitado**
3. En **Site URL**, configura: `https://main.dnpo8nagdov1i.amplifyapp.com`

### Paso 3: Configurar URLs permitidas

1. Ve a **Authentication → URL Configuration**
2. Añade estas URLs en **Redirect URLs**:
   - `http://localhost:5173/registro`
   - `http://localhost:5173/login`
   - `https://main.dnpo8nagdov1i.amplifyapp.com/registro`
   - `https://main.dnpo8nagdov1i.amplifyapp.com/login`
   - `ondeon-smart://login` (para apps móviles)
   - `ondeon-smart://registro` (para apps móviles)
